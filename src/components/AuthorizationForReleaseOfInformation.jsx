...
*/}                        </div>
                        ...
                        <div className="w-1/2 flex flex-col gap-2">
                            <input
                                ...
                                className="border border-black bg-gray-100 h-6 md:h-8 w-full px-1 focus:outline-blue-500"
                            />
                    ...
                    <div className="flex mb-4">
                        ...
                        <div className="w-[90%]">
                            <input
                                ...
                                onChange={(e) => handleNestedChange('fromProvider', 'name', e.target.value)}
                                onKeyDown={handleEnter}
                            ...
                            <div className="flex gap-2">
                                <div className="w-2/3">
                                    <input
                                        ...
                                        onChange={(e) => handleNestedChange('fromProvider', 'address', e.target.value)}
                                        onKeyDown={handleEnter}
                                        className="bg-blue-50 border border-blue-200 h-8 mb-1 w-full px-1"
                                    />
                                ...
                                <div className="w-1/3">
                                    <input
                                        ...
                                        onChange={(e) => handleNestedChange('fromProvider', 'phone', e.target.value)}
                                        onKeyDown={handleEnter}
                                        className="bg-blue-50 border border-blue-200 h-8 mb-1 w-full px-1"
                                    />
                    ...
                    <div className="flex mb-8">
                        ...
                        <div className="w-[90%]">
                            <input
                                ...
                                onChange={(e) => handleNestedChange('toProvider', 'name', e.target.value)}
                                onKeyDown={handleEnter}
                                className="bg-blue-50 border border-blue-200 h-8 mb-1 w-full px-1"
                            />
                            ...
                            <div className="flex gap-2">
                                <div className="w-2/3">
                                    <input
                                        ...
                                        onChange={(e) => handleNestedChange('toProvider', 'address', e.target.value)}
                                        onKeyDown={handleEnter}
                                        className="bg-blue-50 border border-blue-200 h-8 mb-1 w-full px-1"
                                    />
                                    <div className="text-[8px] md:text-xs text-center">(Address)</div>
                                ...
                                <div className="w-1/3">
                                    <input
                                        ...
                                        onChange={(e) => handleNestedChange('toProvider', 'phone', e.target.value)}
                                        onKeyDown={handleEnter}
                                        className="bg-blue-50 border border-blue-200 h-8 mb-1 w-full px-1"
                                    />
                                    <div className="text-[8px] md:text-xs text-center">(Phone/Fax)</div>
                    ...
                    <div className="flex gap-4 mb-4">
                        ...
                        <div className="w-full">
                            ...
                            <textarea
                                ...
                                onChange={(e) => handleNestedChange('authInfo', 'details', e.target.value)}
                    ...
                    <div className="flex gap-4 mb-4">
                        <div className="flex flex-col items-center">
                            <input
                                ...
                                onChange={() => handleCheckboxChange('authAlcoholDrug', 'initials')}
                                className="w-6 h-6 border border-black mb-1 focus:outline-blue-500 rounded-none accent-black cursor-pointer"
                            />
                            <div className="text-[8px]">Initials</div>
                        </div>
                    ...
                    <input
                        ...
                        onChange={() => handleCheckboxChange('authAlcoholDrug', 'confirmed')}
                    ...
                    <div className="mb-6">
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            className="bg-blue-50 border border-blue-200 h-12 w-full p-2 focus:outline-blue-500 resize-none"
                        ></textarea>
                    </div>
                            ...
                            <div className="flex gap-4 mt-1 items-center">
                                <label className="flex items-center gap-1 cursor-pointer">
                                    <input
                                        ...
                                        onChange={() => setFormData(prev => ({ ...prev, duration: prev.duration === 'oneYear' ? '' : 'oneYear' }))}
                                        className="mx-1"
                                    /> one (1) year OR
                                </label>
                                <label className="flex items-center gap-1 cursor-pointer">
                                    <input
                                        ...
                                        onChange={() => setFormData(prev => ({ ...prev, duration: prev.duration === 'transactionPeriod' ? '' : 'transactionPeriod' }))}
                                        className="mx-1"
                    ...
                    <div className="grid grid-cols-[1fr_1fr_100px] gap-4 mb-4 items-end">
                        <div>
                            <input
                                ...
                                onChange={(e) => handleDeepNestedChange('signaturesPage1', 'client', 'signature', e.target.value)}
                                onKeyDown={handleEnter}
                        ...
                        <div>
                            <input
                                ...
                                onChange={(e) => handleDeepNestedChange('signaturesPage1', 'client', 'printName', e.target.value)}
                                onKeyDown={handleEnter}
                                className="w-full border border-black h-8 px-1 focus:outline-blue-500 mb-1"
                            />
                        ...
                        <div>
                            <input
                                ...
                                onChange={(e) => handleDeepNestedChange('signaturesPage1', 'client', 'date', e.target.value)}
                                onKeyDown={handleEnter}
                                className="w-full border border-black h-8 px-1 focus:outline-blue-500 mb-1"
                            />
                    ...
                    <div className="grid grid-cols-[1fr_1fr_100px] gap-4 mb-2 items-end">
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => handleDeepNestedChange('signaturesPage1', 'authorized', 'signature', e.target.value)}
                                onKeyDown={handleEnter}
                                className="w-full border-b border-black bg-transparent focus:outline-none mb-1"
                            />
                        ...
                        <div>
                            <input
                                ...
                                onChange={(e) => handleDeepNestedChange('signaturesPage1', 'authorized', 'printName', e.target.value)}
                                onKeyDown={handleEnter}
                                className="w-full border border-black h-8 px-1 focus:outline-blue-500 mb-1"
                            />
                            <div className="font-bold text-[8px] md:text-xs">Print Name</div>
                        ...
                        <div>
                            <input
                                ...
                                onChange={(e) => handleDeepNestedChange('signaturesPage1', 'authorized', 'date', e.target.value)}
                                onKeyDown={handleEnter}
                                className="w-full border border-black h-8 px-1 focus:outline-blue-500 mb-1"
                            />
                            <div className="font-bold text-[8px] md:text-xs">Date</div>
                    ...
                    <div className="flex gap-4 mb-2 mt-1">
                        <label className="flex items-center gap-1 cursor-pointer">
                            <input
                                ...
                                onChange={() => handleDeepNestedChange('signaturesPage1', 'authType', 'parent', !formData.signaturesPage1.authType.parent)}
                                className="mx-1"
                            /> Parent
                        </label>
                        <label className="flex items-center gap-1 cursor-pointer">
                            <input
                                ...
                                onChange={() => handleDeepNestedChange('signaturesPage1', 'authType', 'guardian', !formData.signaturesPage1.authType.guardian)}
                                className="mx-1"
                            /> Guardian
                        </label>
                        <label className="flex items-center gap-1 cursor-pointer">
                            <input
                                ...
                                onChange={() => handleDeepNestedChange('signaturesPage1', 'authType', 'custodian', !formData.signaturesPage1.authType.custodian)}
                                className="mx-1"
                    ...
                    <div className="grid grid-cols-[1fr_1fr] gap-8 items-end mb-8">
                        <div>
                            <input
                                ...
                                onChange={(e) => handleNestedChange('revocation', 'date', e.target.value)}
                                onKeyDown={handleEnter}
                        ...
                        <div>
                            <input
                                ...
                                onChange={(e) => handleNestedChange('revocation', 'signature', e.target.value)}
                                onKeyDown={handleEnter}
                    ...
                    <div className="grid grid-cols-[1fr_200px] gap-8 items-end mb-12">
                        <div>
                            <input
                                ...
                                onChange={(e) => handleNestedChange('signaturesPage2', 'signature', e.target.value)}
                                onKeyDown={handleEnter}
                                className="w-full border-b border-black bg-transparent focus:outline-none mb-1"
                            />
                        ...
                        <div>
                            <input
                                ...
                                onChange={(e) => handleNestedChange('signaturesPage2', 'date', e.target.value)}
                                onKeyDown={handleEnter}
